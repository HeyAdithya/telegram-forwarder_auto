...
- Make a <code>.env</code> file in the root of the repo, like <a href="https://github.com/hey-adithya/telegram-forwarder_auto/blob/main/.env.sample">.env.sample</a> and fill in the values.</br>
